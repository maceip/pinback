...
DS4_CONTRACT_PATH = SCRIPT_DIR / "ui" / "ds4-interface-contract.json"
RUNTIME_DIR = Path.home() / ".ds4" / "runtime"
ASSET_PATHS = {
    "/asset/bg-dark.jpg": ("runtime/assets/bg-dark.jpg", "image/jpeg"),
    "/asset/bg-light.jpg": ("runtime/assets/bg-light.jpg", "image/jpeg"),
    "/asset/icon-sheet.jpg": ("runtime/assets/icon-sheet.jpg", "image/jpeg"),
    "/asset/avatar-agent.jpg": ("runtime/assets/avatar-agent.jpg", "image/jpeg"),
    "/asset/avatar-agent-backup.jpg": ("runtime/assets/avatar-agent-backup.jpg", "image/jpeg"),
    "/asset/avatar-user.jpg": ("runtime/assets/avatar-user.jpg", "image/jpeg"),
    "/asset/panels-wide.jpg": ("runtime/assets/panels-wide.jpg", "image/jpeg"),
    "/asset/panel-large.jpg": ("runtime/assets/panel-large.jpg", "image/jpeg"),
    "/asset/app-icon.jpg": ("runtime/assets/app-icon.jpg", "image/jpeg"),
    "/asset/app-wordmark.jpg": ("runtime/assets/app-wordmark.jpg", "image/jpeg"),
    "/asset/app-rmark.jpg": ("runtime/assets/app-rmark.jpg", "image/jpeg"),
    "/asset/offline.jpg": ("runtime/assets/offline.jpg", "image/jpeg"),
    "/asset/engine-cube.jpg": ("runtime/assets/engine-cube.jpg", "image/jpeg"),
    "/asset/pattern-filler.jpg": ("runtime/assets/pattern-filler.jpg", "image/jpeg"),
}
...
<body>
  <main>
    ...
    <p>Build it with <code>cd runtime/ui && bun run build</code>, then reload.</p>
  </main>
</body>
</html>"""
