...
def parse_args(argv: Sequence[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--runtime-dir", default="/Users/mac/webkitium/.runtime/ds4")
    parser.add_argument("--state-file", default="/Users/mac/webkitium/.runtime/ds4-supervisor/state.json")
    parser.add_argument("--log-dir", default="/Users/mac/webkitium/.runtime/ds4-supervisor/logs")
